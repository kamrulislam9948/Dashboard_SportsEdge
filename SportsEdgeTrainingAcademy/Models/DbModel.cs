...
namespace SportsEdgeTrainingAcademy.Models
{
    ...
    public class SportsEdgeDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sport>().HasData(
                new Sport { SportId = 1, SportsName = "Football" },
                new Sport { SportId = 2, SportsName = "Basketball" },
                new Sport { SportId = 3, SportsName = "Volleyball" },
                new Sport { SportId = 4, SportsName = "Tennis" },
                new Sport { SportId = 5, SportsName = "Swimming" }
            );
            ...
            modelBuilder.Entity<SelectionPanel>().HasData(
                new SelectionPanel{SelectionPanelId = 1,SelectorName = "Selection Committee 1",CoachId = 1, MedicalAdvisorId = 1},
                new SelectionPanel{SelectionPanelId = 2,SelectorName = "Selection Committee 2",CoachId = 2,MedicalAdvisorId = 2},
                new SelectionPanel{SelectionPanelId = 3,SelectorName = "Selection Committee 3",CoachId = 3,MedicalAdvisorId = 3},
            
                new SelectionPanel{SelectionPanelId = 4,SelectorName = "Selection Committee 4",CoachId = 4,MedicalAdvisorId = 4},
               
                new SelectionPanel{SelectionPanelId = 5,SelectorName = "Selection Committee 5",CoachId = 5,MedicalAdvisorId = 5}
            );

            // Team
            modelBuilder.Entity<Team>().HasData(
                new Team{TeamId = 2,TeamName = "Team B",Captain = "Player Captain 2",SportId = 2, TeamLogo = "logo1.jpg" },
                new Team{TeamId = 3,TeamName = "Team C",Captain = "Player Captain 3",SportId = 3, TeamLogo = "logo2.jpg" },
                new Team{TeamId = 4,TeamName = "Team D",Captain = "Player Captain 4",SportId = 4, TeamLogo = "logo3.jpg" },
                new Team{TeamId = 5,TeamName = "Team E",Captain = "Player Captain 5",SportId = 5, TeamLogo = "logo4.jpg" },
                new Team{TeamId = 6,TeamName = "Team F",Captain = "Player Captain 6",SportId = 1,TeamLogo = "logo5.jpg"}
            );
